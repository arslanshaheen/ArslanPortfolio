...
//         <h1 className="h1 mb-6">Hello I`m <br /><span className="text-accent">Arslan</span></h1>
//         <p className="max-w-[500px] mb-9 text-white/80">I excel at creafting elegant digital experience and I am proficient in various programming language and technologies...</p>
//        {/* btn and social */}
...
//       </div>
//       </div>
//       <div className="mt-0 m"><Stats /></div>
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I&apos;m <br />{" "}
              <span className="text-accent">Arslan</span>
            </h1>
